...
import type { WeeklyDataChartProps } from "@/types/props";
import type {
  WeeklyDataUrlParams,
  WeeklyDataEntry,
} from "@/types/weekly-chart";
...
export default function WeeklyDataChart(props: WeeklyDataChartProps) {
  ...
  useEffect(() => {
    ...
    const fetchDataWithFilters = async () => {
      ...
      try {
        ...
        let sortedByWeekStart = weeklyData.sort((weekA, weekB) => sortByWeekStart(weekA, weekB))
